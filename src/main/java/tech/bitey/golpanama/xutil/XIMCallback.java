...
public class XIMCallback {
    ...
    public static MemoryAddress client_data$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)XIMCallback.client_data$VH.get(seg);
    }
    ...
    public static MemoryAddress client_data$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)XIMCallback.client_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)XIMCallback.callback$VH.get(seg);
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)XIMCallback.callback$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static XIMProc callback (MemorySegment segment, ResourceScope scope) {
