...
public class XwcTextItem {
    ...
    public static MemoryAddress chars$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)XwcTextItem.chars$VH.get(seg);
    }
    ...
    public static MemoryAddress chars$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)XwcTextItem.chars$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress font_set$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)XwcTextItem.font_set$VH.get(seg);
    }
    ...
    public static MemoryAddress font_set$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)XwcTextItem.font_set$VH.get(seg.asSlice(index*sizeof()));
    }
