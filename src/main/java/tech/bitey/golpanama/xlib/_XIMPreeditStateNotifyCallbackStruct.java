...
public class _XIMPreeditStateNotifyCallbackStruct {
    ...
    private static final OfLong state$LAYOUT = (OfLong)$LAYOUT.select(groupElement("state"));
     ...
     * }
     */
    public static final OfLong state$layout() {
        return state$LAYOUT;
    }
     ...
     * }
     */
    public static long state(MemorySegment struct) {
     ...
     * }
     */
    public static void state(MemorySegment struct, long fieldValue) {
