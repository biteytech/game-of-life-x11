...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Xlib_h.C_INT.withName("__lock"),
        Xlib_h.C_INT.withName("__count"),
        Xlib_h.C_INT.withName("__owner"),
        Xlib_h.C_INT.withName("__nusers"),
        Xlib_h.C_INT.withName("__kind"),
        Xlib_h.C_SHORT.withName("__spins"),
        Xlib_h.C_SHORT.withName("__elision"),
