...
public class XReparentEvent {
    ...
    public static long event$get(MemorySegment seg) {
        return (long)constants$76.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long event$get(MemorySegment seg, long index) {
        return (long)constants$76.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int x$get(MemorySegment seg) {
        return (int)constants$76.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int x$get(MemorySegment seg, long index) {
        return (int)constants$76.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int override_redirect$get(MemorySegment seg) {
        return (int)constants$77.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int override_redirect$get(MemorySegment seg, long index) {
        return (int)constants$77.const$0.get(seg.asSlice(index*sizeof()));
    }
