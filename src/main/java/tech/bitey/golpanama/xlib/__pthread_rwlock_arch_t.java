...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Xlib_h.C_INT.withName("__readers"),
        Xlib_h.C_INT.withName("__writers"),
        Xlib_h.C_INT.withName("__wrphase_futex"),
        Xlib_h.C_INT.withName("__writers_futex"),
        Xlib_h.C_INT.withName("__pad3"),
        Xlib_h.C_INT.withName("__pad4"),
        Xlib_h.C_INT.withName("__cur_writer"),
        Xlib_h.C_INT.withName("__shared"),
        Xlib_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, Xlib_h.C_CHAR).withName("__pad1"),
        Xlib_h.C_LONG.withName("__pad2"),
        Xlib_h.C_INT.withName("__flags"),
