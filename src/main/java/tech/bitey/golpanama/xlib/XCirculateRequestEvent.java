...
public class XCirculateRequestEvent {
    ...
    private static final OfInt place$LAYOUT = (OfInt)$LAYOUT.select(groupElement("place"));
     ...
     * }
     */
    public static final OfInt place$layout() {
        return place$LAYOUT;
    }

    private static final long place$OFFSET = 48;
     ...
     * }
     */
    public static final long place$offset() {
        return place$OFFSET;
    }
     ...
     * }
     */
    public static int place(MemorySegment struct) {
        return struct.get(place$LAYOUT, place$OFFSET);
    }
     ...
     * }
     */
    public static void place(MemorySegment struct, int fieldValue) {
        struct.set(place$LAYOUT, place$OFFSET, fieldValue);
    }
