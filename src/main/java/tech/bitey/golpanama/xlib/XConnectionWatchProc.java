 ...
 * }
 */
public class XConnectionWatchProc {
    ...
    private static final MethodHandle UP$MH = Xlib_h.upcallHandle(XConnectionWatchProc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(XConnectionWatchProc.Function fi, Arena arena) {
