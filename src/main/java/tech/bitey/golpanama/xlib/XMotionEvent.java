...
public class XMotionEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Xlib_h.C_CHAR.withName("is_hint"),
    ...
    private static final OfByte is_hint$LAYOUT = (OfByte)$LAYOUT.select(groupElement("is_hint"));
     ...
     * }
     */
    public static final OfByte is_hint$layout() {
        return is_hint$LAYOUT;
    }

    private static final long is_hint$OFFSET = 84;
     ...
     * }
     */
    public static final long is_hint$offset() {
        return is_hint$OFFSET;
    }
     ...
     * }
     */
    public static byte is_hint(MemorySegment struct) {
        return struct.get(is_hint$LAYOUT, is_hint$OFFSET);
    }
     ...
     * }
     */
    public static void is_hint(MemorySegment struct, byte fieldValue) {
        struct.set(is_hint$LAYOUT, is_hint$OFFSET, fieldValue);
    }
