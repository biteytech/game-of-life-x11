...
public class XKeymapEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, Xlib_h.C_CHAR).withName("key_vector")
    ).withName("$anon$653:9");
    ...
    private static final SequenceLayout key_vector$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("key_vector"));
     ...
     * }
     */
    public static final SequenceLayout key_vector$layout() {
        return key_vector$LAYOUT;
    }

    private static final long key_vector$OFFSET = 40;
     ...
     * }
     */
    public static final long key_vector$offset() {
        return key_vector$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment key_vector(MemorySegment struct) {
        return struct.asSlice(key_vector$OFFSET, key_vector$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void key_vector(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, key_vector$OFFSET, key_vector$LAYOUT.byteSize());
    }

    private static long[] key_vector$DIMS = { 32 };
     ...
     * }
     */
    public static long[] key_vector$dimensions() {
        return key_vector$DIMS;
    }
    private static final VarHandle key_vector$ELEM_HANDLE = key_vector$LAYOUT.varHandle(sequenceElement());
     ...
     * }
     */
    public static byte key_vector(MemorySegment struct, long index0) {
        return (byte)key_vector$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void key_vector(MemorySegment struct, long index0, byte fieldValue) {
        key_vector$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }
