...
public class XTextItem {
    ...
    public static MemoryAddress chars$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)XTextItem.chars$VH.get(seg);
    }
    ...
    public static MemoryAddress chars$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)XTextItem.chars$VH.get(seg.asSlice(index*sizeof()));
    }
