...
public class XVisibilityEvent {
    ...
    public static MemoryAddress display$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)XVisibilityEvent.display$VH.get(seg);
    }
    ...
    public static MemoryAddress display$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)XVisibilityEvent.display$VH.get(seg.asSlice(index*sizeof()));
    }
