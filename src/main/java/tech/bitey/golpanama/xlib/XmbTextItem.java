...
public class XmbTextItem {
    ...
    public static MemoryAddress chars$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)XmbTextItem.chars$VH.get(seg);
    }
    ...
    public static MemoryAddress chars$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)XmbTextItem.chars$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress font_set$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)XmbTextItem.font_set$VH.get(seg);
    }
    ...
    public static MemoryAddress font_set$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)XmbTextItem.font_set$VH.get(seg.asSlice(index*sizeof()));
    }
