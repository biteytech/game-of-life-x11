...
public class XPropertyEvent {
    ...
    private static final OfLong atom$LAYOUT = (OfLong)$LAYOUT.select(groupElement("atom"));
     ...
     * }
     */
    public static final OfLong atom$layout() {
        return atom$LAYOUT;
    }

    private static final long atom$OFFSET = 40;
     ...
     * }
     */
    public static final long atom$offset() {
        return atom$OFFSET;
    }
     ...
     * }
     */
    public static long atom(MemorySegment struct) {
        return struct.get(atom$LAYOUT, atom$OFFSET);
    }
     ...
     * }
     */
    public static void atom(MemorySegment struct, long fieldValue) {
        struct.set(atom$LAYOUT, atom$OFFSET, fieldValue);
    }
