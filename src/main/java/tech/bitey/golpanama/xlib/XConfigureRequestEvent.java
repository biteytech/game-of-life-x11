...
public class XConfigureRequestEvent {
    ...
    public static long parent$get(MemorySegment seg) {
        return (long)constants$83.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long parent$get(MemorySegment seg, long index) {
        return (long)constants$83.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long window$get(MemorySegment seg) {
        return (long)constants$83.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long window$get(MemorySegment seg, long index) {
        return (long)constants$83.const$2.get(seg.asSlice(index*sizeof()));
    }
