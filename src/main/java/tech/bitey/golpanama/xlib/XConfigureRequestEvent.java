...
public class XConfigureRequestEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        Xlib_h.C_LONG.withName("value_mask")
    ).withName("$anon$801:9");
    ...
    private static final long detail$OFFSET = 80;
    ...
    private static final OfLong value_mask$LAYOUT = (OfLong)$LAYOUT.select(groupElement("value_mask"));
     ...
     * }
     */
    public static final OfLong value_mask$layout() {
        return value_mask$LAYOUT;
    }

    private static final long value_mask$OFFSET = 88;
     ...
     * }
     */
    public static final long value_mask$offset() {
        return value_mask$OFFSET;
    }
     ...
     * }
     */
    public static long value_mask(MemorySegment struct) {
        return struct.get(value_mask$LAYOUT, value_mask$OFFSET);
    }
     ...
     * }
     */
    public static void value_mask(MemorySegment struct, long fieldValue) {
        struct.set(value_mask$LAYOUT, value_mask$OFFSET, fieldValue);
    }
